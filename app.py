...
# 1. 페이지 설정: 오팔 Surreal Elegance 스타일
...
try:
    ...
    # v1beta 등 모든 버전에서 가장 안정적인 모델명 사용
    ...
    if user_input:
        with st.spinner("오팔 엔진이 크리처를 설계 중입니다..."):
            try:
                ...
                # try와 정확히 같은 들여쓰기 위치에 배치하여 SyntaxError 해결
